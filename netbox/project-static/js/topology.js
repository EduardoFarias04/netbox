    ...
    var options = {
        ...
        manipulation: {
            ...
            addEdge: function(edgeData,callback) {
                ...
                api_load('/api/dcim/interfaces/?device_id='+edgeData.from, function(response, status){
                ...
                api_load('/api/dcim/interfaces/?device_id='+edgeData.to, function(response, status){
